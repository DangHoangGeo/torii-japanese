...
import { n as getPglite, t as ensureDbReady } from "./db-C7Wb8kIp.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-C21KxFE5.js
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-CjldIDVK.mjs").then((n) => n.i).then((n) => n.t);
