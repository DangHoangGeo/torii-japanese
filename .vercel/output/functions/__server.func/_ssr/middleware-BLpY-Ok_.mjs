...
//#region node_modules/.nitro/vite/services/ssr/assets/middleware-BLpY-Ok_.js
/**
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	const { getBearerToken } = await import("./client-kg1JE--1.mjs").then((n) => n.n);
	return next({ sendContext: { bearerToken: getBearerToken() ?? void 0 } });
}).server(async ({ next, context }) => {
	const { assertSameSiteRequest } = await import("./isolation.server-DdaYS3Bg.mjs");
	const { requireUserId } = await import("./verify.server-DlAV8K6Z.mjs");
